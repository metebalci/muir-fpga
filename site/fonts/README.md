...
subset only --- every character these pages use is in it.

| file | face | |
|---|---|---|
| `archivo.woff2` | Archivo | one variable file, weights 400 to 600 |
...
To refresh them, ask Google Fonts for the same families and take the faces
