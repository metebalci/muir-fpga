...
//!
//! - `lpc`, `Rtl::lpc()` sampled *before* the step, the 25S07s at LPC
...
fn main() {
    ...
    println!(
        "# cycle pc ir q a m alu r ob dc opc st lc \
         ...
         lpc promdis errstop stathenb speed1 speed0 stall halted bus ns"
    );
    ...
    for cycle in 0..CYCLES {
        ...
        line.push_str(&format!(
            " {:x} {:x} {:x} {:x} {:x} {:x} {stall:x} {halted:x} {bus:x} {:x}",
            lpc,
