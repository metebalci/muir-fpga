...
# answers.
#
#     ~/Xilinx/2026.1/Vivado/bin/xsdb vivado/ddr_check.tcl
...
# The same shape as the DONE bit in `vivado/program.tcl`.
#
...
#                     the bottom of it.
#
# The region is `rtl/cadr_ddr_map.sv`'s: 0x1800_0000 for 128 MB, which is what
...
# ------------------------------------------------------------------ the map
# rtl/cadr_ddr_map.sv: RESERVED_BASE, and MAIN_BASE on top of it.
set MAIN_BASE   0x18000000
set DDR_TOP     0x20000000
set RESERVED_MB 128

# The proving address and word, the same pair `rtl/cadr_arty.sv` gives the
