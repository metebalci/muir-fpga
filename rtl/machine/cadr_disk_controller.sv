...
// reference trace's `ATTACH` row says; `boards/arty-z7-20/cadr_arty.sv` ties all three off
...
// trace and `boards/arty-z7-20/cadr_arty.sv` tied it to zero.  **Measured on the board on
...
module cadr_disk_controller #(
    ...
    //
    // **WHAT DRIVES THIS.**  `rtl/plumbing/cadr_disk_pack.sv`, the pack side: the
