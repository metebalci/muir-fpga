...
// scanned at.  The monitor here runs at 60 Hz.  Neither number constrains the
// other: MIT's TV had the processor and the raster reading one memory at
// whatever rates each ran at, and so does this.  The vertical flag the machine
// reads is `cadr_tv.sv`'s and is not this module's VSYNC.
//
