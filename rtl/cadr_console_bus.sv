...
// mode register there through `cadr_busint_xbus`, and `rtl/cadr_console.sv`,
...
// `rtl/cadr_machine.xdc` can reach it.**
//
...
// relaxed with it, which is the trap `rtl/cadr_machine.xdc` records at
...
module cadr_console_bus (
    ...
    // --- the console, `rtl/cadr_console.sv`, a level above this one
    ...
    // --- the register block, `rtl/cadr_spy_registers.sv`
