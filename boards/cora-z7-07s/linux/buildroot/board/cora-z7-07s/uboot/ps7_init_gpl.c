...
/*
 * The Cora Z7-07S's Zynq start-up routine, for U-Boot's SPL.
 *
 * GENERATED by boards/cora-z7-07s/linux/buildroot/board/cora-z7-07s/uboot/gen_ps7_init_gpl.py
 * from boards/cora-z7-07s/vivado/ps7_init.ops.  Do not edit; run the generator.  Its header
