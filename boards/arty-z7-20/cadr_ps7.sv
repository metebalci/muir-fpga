...
module cadr_ps7 (
  ...
  PS7 u_ps7 (
      ...
      .SAXIHP3ACLK(hp3_aclk),
      .SAXIHP3ARESETN(hp3_aresetn),
      .SAXIHP3AWADDR(hp3_awaddr),
      .SAXIHP3AWLEN(hp3_awlen),
      .SAXIHP3AWSIZE(hp3_awsize),
      .SAXIHP3AWBURST(hp3_awburst),
      .SAXIHP3AWVALID(hp3_awvalid),
      .SAXIHP3AWREADY(hp3_awready),
      .SAXIHP3WDATA(hp3_wdata),
      .SAXIHP3WSTRB(hp3_wstrb),
      .SAXIHP3WLAST(hp3_wlast),
      .SAXIHP3WVALID(hp3_wvalid),
      .SAXIHP3WREADY(hp3_wready),
      .SAXIHP3BRESP(hp3_bresp),
      .SAXIHP3BVALID(hp3_bvalid),
      .SAXIHP3BREADY(hp3_bready),
      .SAXIHP3ARADDR(hp3_araddr),
      .SAXIHP3ARLEN(hp3_arlen),
      .SAXIHP3ARSIZE(hp3_arsize),
      .SAXIHP3ARBURST(hp3_arburst),
      .SAXIHP3ARVALID(hp3_arvalid),
      .SAXIHP3ARREADY(hp3_arready),
      .SAXIHP3RDATA(hp3_rdata),
      .SAXIHP3RRESP(hp3_rresp),
      .SAXIHP3RLAST(hp3_rlast),
      .SAXIHP3RVALID(hp3_rvalid),
      .SAXIHP3RREADY(hp3_rready),
      ...
      .MAXIGP1ARLEN(gp1_arlen),
      .MAXIGP1ARID(gp1_arid),
      ...
      // as AWCACHE
      .SAXIHP3ARCACHE(4'b0011),
      // as HP0's, though this port only reads
      .SAXIHP3AWCACHE(4'b0011),
