...
#         timeout 900 ~/Xilinx/2026.1/Vivado/bin/xsdb boards/arty-z7-20/vivado/prove_write.tcl
#
# Run from the repository root.  `boards/arty-z7-20/vivado/ddr_check.tcl` is step one and its
...
#      error --- `boards/arty-z7-20/vivado/program.tcl` makes the same point about the same bit,
...
# `boards/arty-z7-20/vivado/ddr_check.tcl` is --- but a controller that did not come up makes
...
# DONE, from where `boards/arty-z7-20/vivado/program.tcl` and `boards/arty-z7-20/vivado/probe.tcl` both read it:
