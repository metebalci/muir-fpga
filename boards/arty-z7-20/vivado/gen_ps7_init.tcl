...
# TAKEN FOR THIS. `boards/arty-z7-20/cadr_ps7.sv` instantiates the PS7 primitive rather than
...
#
# WHAT IT GENERATES IS NOT CHECKED BY EYE. boards/arty-z7-20/vivado/ps7_ops.py extracts the
# ordered register operations from the routine and compares them against the
# committed boards/arty-z7-20/vivado/ps7_init.ops, so a change in Digilent's configuration or in
...
# not `cadr_ps7` --- that name is the fabric wrapper `boards/arty-z7-20/vivado/gen_ps7.py`
...
source boards/arty-z7-20/vivado/ps7_config.tcl
if {![info exists ps7_config]} {
    puts "gen_ps7_init: boards/arty-z7-20/vivado/ps7_config.tcl set no ps7_config"
    exit 1
}
