...
#
# WHERE THE DATA COMES FROM, AND WHY FROM THERE.  boards/arty-z7-20/vivado/ps7_init.ops is the
...
# boards/arty-z7-20/vivado/ps7_ops.py from the ps7_init.tcl that boards/arty-z7-20/vivado/gen_ps7_init.tcl
...
REPO = os.path.abspath(os.path.join(HERE, "..", "..", "..", "..", "..",
                                    "..", ".."))
OPS = os.path.join(REPO, "boards", "arty-z7-20", "vivado", "ps7_init.ops")
 ...
 *
 * GENERATED by boards/arty-z7-20/linux/buildroot/board/arty-z7-20/uboot/gen_ps7_init_gpl.py
 * from boards/arty-z7-20/vivado/ps7_init.ops.  Do not edit; run the generator.  Its header
...
def main():
    ...
    if args.check:
        ...
        if have != text:
            die("%s is not what boards/arty-z7-20/vivado/ps7_init.ops gives today; run the "
